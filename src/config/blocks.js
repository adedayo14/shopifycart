// Auto-generated from extensions/theme-extension/blocks/*.liquid files
// DO NOT EDIT MANUALLY - Run 'npm run generate-blocks' to regenerate

module.exports = [
  {
    "id": "category-image-hover",
    "name": "Category Image with Hover",
  ...
  {
    "id": "hero-advertisement",
    "name": "Hero Advertisement",
  ...
  {
    "id": "image-compare-pro",
    "name": "Image Compare Pro",
    "description": "Image Compare Pro",
    "category": "Media",
    "price": 29,
    "isActive": true
  },
  {
    "id": "ingredient-info-block",
    "name": "Ingredient Info Block",
  ...
  {
    "id": "key-features-display",
    "name": "Features Display",
    "description": "Features Display",
    "category": "Content",
    "price": 29,
    "isActive": true
  },
  ...
  {
    "id": "single-product-highlight",
    "name": "Single Product Highlight",
  ...
  {
    "id": "three-column-display",
    "name": "Three Column Display",
